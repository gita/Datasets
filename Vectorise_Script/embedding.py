...
for i in range(1,20): #19 chapters in Canto 1 
    with open('chapter'+str(i)+'.json', encoding='utf-8') as fh:
    ...
    with open('chapter'+str(i)+'_vectorised.json', "w", encoding="utf-8") as f:
